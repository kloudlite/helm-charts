...
redpanda:
  saslUsername: admin
  saslPassword: lPHz3L0pxNOE5v0QScX-c2AN9D4a6ZITlH-FpzBw
  ...
  kafkaBrokers: kafka.kloudlite.io:31787 
  rpkAdminFlags: --user admin --password lPHz3L0pxNOE5v0QScX-c2AN9D4a6ZITlH-FpzBw --api-urls redpanda.kl-init-redpanda.svc.cluster.local:9644
  rpkSaslFlags: --user admin --password lPHz3L0pxNOE5v0QScX-c2AN9D4a6ZITlH-FpzBw --brokers redpanda.kl-init-redpanda.svc.cluster.local:9092 --sasl-mechanism SCRAM-SHA-256
...
stripe:
  publicKey: pk_test_Ft3Q8BTGCjffPqNfnQPdTYjq
  secretKey: sk_test_51E8jabHarTAKc4zfN11hcjJbpdXDgz4D7nIAqYajMsgLBkhW5IbumHcQjJ5H9JIleyxCKk1sucoDLNznOdNNYzyW00eIFTxscO
